...
export const FAVORITE_MODEL_STORAGE_KEYS = {
  cursor: "scient:cursor-favourite-models:v1",
  kilo: "scient:kilo-favourite-models:v1",
  opencode: "scient:opencode-favourite-models:v1",
  pi: "scient:pi-favourite-models:v1",
} as const;
